...
ENT.StartHealth = GetConVarNumber("vj_nmrih_walkmalez_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walkmalez_d_single")
...
function ENT:CustomOnInitialize()
	...
	if randomstartskin == 1 then self:SetModel(Model("models/VJ_NMRIH/toby.mdl")) else
	if randomstartskin == 2 then self:SetModel(Model("models/VJ_NMRIH/runner.mdl")) end
	if randomstartskin == 3 then self:SetModel(Model("models/VJ_NMRIH/officezom.mdl")) self:SetSkin(3) end
	if randomstartskin == 4 then self:SetModel(Model("models/VJ_NMRIH/officezom.mdl")) self:SetSkin(2) end
	if randomstartskin == 5 then self:SetModel(Model("models/VJ_NMRIH/officezom.mdl")) self:SetSkin(1) end
	if randomstartskin == 6 then self:SetModel(Model("models/VJ_NMRIH/officezom.mdl")) end
	if randomstartskin == 7 then self:SetModel(Model("models/VJ_NMRIH/maxx.mdl")) end
	if randomstartskin == 8 then self:SetModel(Model("models/VJ_NMRIH/jogger.mdl")) self:SetSkin(3) end
	if randomstartskin == 9 then self:SetModel(Model("models/VJ_NMRIH/jogger.mdl")) self:SetSkin(2) end
	if randomstartskin == 10 then self:SetModel(Model("models/VJ_NMRIH/jogger.mdl")) self:SetSkin(1) end
	if randomstartskin == 11 then self:SetModel(Model("models/VJ_NMRIH/jogger.mdl")) end
	if randomstartskin == 12 then self:SetModel(Model("models/VJ_NMRIH/herby.mdl")) end
	if randomstartskin == 13 then self:SetModel(Model("models/VJ_NMRIH/casual_02.mdl")) self:SetSkin(2) end
	if randomstartskin == 14 then self:SetModel(Model("models/VJ_NMRIH/casual_02.mdl")) self:SetSkin(1) end
	if randomstartskin == 15 then self:SetModel(Model("models/VJ_NMRIH/casual_02.mdl")) end
	if randomstartskin == 16 then self:SetModel(Model("models/VJ_NMRIH/berny.mdl")) end
	if randomstartskin == 17 then self:SetModel(Model("models/VJ_NMRIH/berny.mdl")) self:SetSkin(1) end
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:MultipleMeleeAttacks()
	if self.Zombie_IsCrawling == true then
		...
		self.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walkmalez_d_single")
	else
		...
		elseif randattack == 2 then
			...
			self.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walkmalez_d_dualfast")
		elseif randattack == 3 then
			...
			self.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walkmalez_d_dualslow")
		end
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
