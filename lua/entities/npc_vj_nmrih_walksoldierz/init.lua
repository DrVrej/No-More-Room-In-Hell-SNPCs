...
ENT.StartHealth = GetConVarNumber("vj_nmrih_walksoldierz_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walksoldierz_d_single")
...
function ENT:MultipleMeleeAttacks()
	if self.Zombie_IsCrawling == true then
		...
		self.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walksoldierz_d_single")
	else
		...
		elseif randattack == 2 then
			...
			self.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walksoldierz_d_dualfast")
		elseif randattack == 3 then
			...
			self.MeleeAttackDamage = GetConVarNumber("vj_nmrih_walksoldierz_d_dualslow")
		end
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
